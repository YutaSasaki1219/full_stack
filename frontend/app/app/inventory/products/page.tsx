...
export default function Page() {
    ...
    return (
        <>
            <h2>商品一覧</h2>
            <button onClick={(event) => handleShowNewRow(event)}>商品を追加する</button>
            <table>
                <thead>
                    <tr>
                        <th>商品ID</th>
                ...
                <tbody>
                    {shownNewRow ? (
                        <tr>
                            ...
                            <td><input type="number" onChange={handleInput} name='price'/></td>
                            <td><input type="text" onChange={handleInput} name='description'/></td>
                            <td></td>
                            <td>
